...
export const list = (params?: Partial<User.UserInfo>) => {
  return http.get<httpNs.Response<User.UserInfo[]>>(`${baseUri}/list`, params);
};

export const listPage = (params: Partial<User.UserInfo>) => {
  return http.get<httpNs.Page<User.UserInfo[]>>(`${baseUri}/listPage`, params);
};
...
export const listWithDisabledByGroupId = (params: { userGroupId: string }) => {
  return http.get<httpNs.Response<User.UserBindSelect[]>>(`${baseUri}/listWithDisabledByGroupId/${params.userGroupId}`);
};
...
export const listWithDisabledByRoleId = (params: { roleId: string }) => {
  return http.get<httpNs.Response<User.UserBindSelect[]>>(`${baseUri}/listWithDisabledByRoleId/${params.roleId}`);
};
...
export const listUserLinkByGroupId = (params: { userGroupId: string }) => {
  return http.get<httpNs.Response<User.UserLinkInfo[]>>(`${baseUri}/listUserLinkByGroupId/${params.userGroupId}`, {
    ...params,
...
export const listUserLinkByRoleId = (params: { roleId: string }) => {
  return http.get<httpNs.Response<User.UserLinkInfo[]>>(`${baseUri}/listUserLinkByRoleId/${params.roleId}`, {
    ...params,
    roleId: undefined,
  });
};
