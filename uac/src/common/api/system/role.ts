...
export const list = (params: Partial<Role.RoleInfo>) => {
  return http.get<httpNs.Response<Role.RoleInfo[]>>(`${baseUri}/list`, params);
};
...
export const listPage = (params: Partial<Role.RoleInfo>) => {
  return http.get<httpNs.Page<Role.RoleInfo[]>>(`${baseUri}/listPage`, params);
};
...
export const listRoleLinkByUserId = (params: { appId: string; userId: string }) => {
  return http.get<httpNs.Response<Role.RoleLinkInfo[]>>(
...
export const listRoleLinkByGroupId = (params: { userGroupId: string }) => {
  return http.get<httpNs.Response<Role.RoleLinkInfo[]>>(`${baseUri}/listRoleLinkByGroupId/${params.userGroupId}`, {
    ...params,
...
export const listWithDisabledByUserId = (params: { appId: string; userId: string }) => {
  return http.get<httpNs.Response<Role.RoleBindSelect[]>>(
...
export const listWithDisabledByGroupId = (params: { userGroupId: string }) => {
  return http.get<httpNs.Response<Role.RoleBindSelect[]>>(`${baseUri}/listWithDisabledByGroupId/${params.userGroupId}`);
};
...
export const removeUserFromRole = (ids: string[]) => {
  return http.delete<httpNs.Response<boolean>>(`${baseUri}/removeUserFromRole/${ids.join(",")}`);
};
