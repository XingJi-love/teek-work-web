...
export const getProjectByProjectId = (projectId: string) => {
  return http.get<httpNs.Response<Project.ProjectInfo>>(`${baseUri}/getByProjectId/${projectId}`);
};

export const listProject = (params?: Project.ProjectSearch) => {
  return http.get<httpNs.Response<Project.ProjectInfo[]>>(`${baseUri}/list`, params);
};
...
export const removeProject = (data: Project.ProjectDelete) => {
  return http.delete<httpNs.Response<string>>(`${baseUri}/${data.projectId}`);
};
...
export const transferProject = (projectId: string, teamId: string) => {
  return http.post<httpNs.Response<string>>(`${baseUri}/transferProject/${projectId}/${teamId}`);
};
