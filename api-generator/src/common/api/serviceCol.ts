...
export const listByServiceId = (serviceId: string) => {
  return http.get<httpNs.Response<ServiceCol.ServiceColInfo[]>>(`${baseUri}/listByServiceId/${serviceId}`);
};

export const listServiceColPage = (params?: httpNs.PageData<ServiceCol.ServiceColSearch>) => {
  return http.get<httpNs.Response<ServiceCol.ServiceColInfo[]>>(`${baseUri}/listPage`, params);
};
...
export const removeServiceCol = (data: ServiceCol.ServiceColDelete) => {
  return http.delete<httpNs.Response<string>>(`${baseUri}/${data.id}`);
};

export const reGenCol = (serviceId: string) => {
  return http.post<httpNs.Response<string>>(`${baseUri}/reGenCol/${serviceId}`);
};
export const removeInvalidCol = (serviceId: string) => {
  return http.post<httpNs.Response<string>>(`${baseUri}/removeInvalidCol/${serviceId}`);
};

export const editBatch = (data: ServiceCol.ServiceColUpdateBatch) => {
  return http.put<httpNs.Response<string>>(`${baseUri}/editBatch`, data);
};
