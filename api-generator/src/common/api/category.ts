...
export const listCategory = (params?: Category.CategorySearch) => {
  return http.get<httpNs.Response<Category.CategoryInfo[]>>(`${baseUri}/list`, params);
};

export const listCategoryPage = (params?: httpNs.PageData<Category.CategorySearch>) => {
  return http.get<httpNs.Response<Category.CategoryInfo[]>>(`${baseUri}/listPage`, params);
};
...
export const removeCategory = (data: Category.CategoryDelete) => {
  return http.delete<httpNs.Response<string>>(`${baseUri}/${data.categoryId}`);
};
